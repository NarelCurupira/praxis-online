...
export function AuthPage() {
  ...
  return <div className="auth-shell"><section className="auth-card"><img className="auth-logo auth-logo-light" src="/brand/logo-horizontal-light.webp" alt="Práxis — Controle de Processos" /><img className="auth-logo auth-logo-dark" src="/brand/logo-horizontal-dark.webp" alt="Práxis — Controle de Processos" /><p className="eyebrow">Acesso seguro</p><h1>{title}</h1><p>{description}</p>
