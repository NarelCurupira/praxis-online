  ...
  return <>
    <aside className="sidebar">
      <div className="brand praxis1-brand">
        <img className="praxis1-brand-logo" src="/brand/praxis-1-logo-dark.svg" alt="Práxis" />
        <img className="praxis1-brand-symbol" src="/brand/praxis-1-mark.svg" alt="Práxis" />
      </div>
    ...
    <nav className="mobile-bottom-nav" aria-label="Navegação principal">
      ...
      <button
        type="button"
        className={page === profilePage ? "active" : ""}
        onClick={() => onChange(profilePage)}
        aria-label="Perfil e preferências"
      >
        <UserRound />
        <span>Perfil</span>
      </button>
