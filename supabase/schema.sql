...
-- Para novas instalações, use a ordem explícita de scripts/migrations-order.json.
-- A ordenação alfabética dos nomes históricos não respeita todas as dependências.
-- Em bancos 1.0 existentes, execute somente migrations/20260914_praxis_v110.sql.
